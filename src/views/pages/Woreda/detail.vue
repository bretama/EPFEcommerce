    ...
    <vx-card id="internal-card" no-shadow card-border>
      ...
      >
        <template>
          <vs-tr>
            <vs-td
              class="pr-4 w-1/4">{{$t('woredaName')}}</vs-td>
            <vs-td class="p-0">{{item.name}}</vs-td>
          </vs-tr>
          <vs-tr>
            <vs-td
              class="pr-4 w-1/4">{{$t('Zone')}}</vs-td>
            <vs-td class="p-0">{{item.zoneName}}</vs-td>
          </vs-tr>
          <vs-tr>
            <vs-td
              class="pr-4 w-1/4">{{$t('Region')}}</vs-td>
            <vs-td class="p-0">{{item.regionName}}</vs-td>
          </vs-tr>
          <vs-tr>
            <vs-td
              class="pr-4 w-1/4">{{$t('Country')}}</vs-td>
            <vs-td class="p-0">{{item.countryName}}</vs-td>
          </vs-tr>
        </template>
      </vs-table>
    </vx-card>
...
export default {
  ...
  methods: {
    ...
    openConfirm(status, woreda, color) {
      this.status[0] = true;
      if (status == true) {
